...
import { idlFactory } from './fist_canister.did.js';
export { idlFactory } from './fist_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FIST_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fist_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fist_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fist_canister.did.js")._SERVICE>}
 */
export const fist_canister = createActor(canisterId);
